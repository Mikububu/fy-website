...
echo "  1. Analyze post content"
echo "  2. Generate 8-12 semantic keywords"
echo "  3. Update keyword tags in HTML"
echo "  4. Optimize all meta tags (OG, Twitter, Schema)"
echo "  5. Add featured image to post content"
echo "  6. Commit ALL changes"
echo "  7. Push to trigger deployment"
echo "  8. Verify on live site"
echo "========================================"
